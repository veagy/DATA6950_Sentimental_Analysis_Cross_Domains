"""
Base class and utilities for Deep Belief Network modules.
...
__all__ = ["DBNModuleBase"]


class DBNModuleBase(DLModule):
    """
    Base class for DBN modules with device/dtype support.
